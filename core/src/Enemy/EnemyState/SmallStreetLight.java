 ...
 * 06:54
 */
public class SmallStreetLight extends DrivingModeEnemy
{
	public SmallStreetLight(GameManager gameManager, int id)
	{
		super(gameManager, id);

		enemyType = EnemyType.SmallLight;

		load("gfx/enemy/driving/small_light/");
		initFromAnimation(BodyStrings.DrivingEnemy, id, gameManager.enemyFactory.DrivingEnemiesSpriteSheet.getAnimation(EnemyFactory.ENEMY_DRIVING_SMALL_LIGHT));
	}
