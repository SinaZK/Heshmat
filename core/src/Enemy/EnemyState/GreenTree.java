 ...
 * 06:54
 */
public class GreenTree extends DrivingModeEnemy
{
	public GreenTree(GameManager gameManager, int id)
	{
		super(gameManager, id);

		enemyType = EnemyType.GreenTree;

		load("gfx/enemy/driving/green_tree/");
		initFromAnimation(BodyStrings.DrivingEnemy, id, gameManager.enemyFactory.DrivingEnemiesSpriteSheet.getAnimation(EnemyFactory.ENEMY_DRIVING_GREEN_TREE));
	}
